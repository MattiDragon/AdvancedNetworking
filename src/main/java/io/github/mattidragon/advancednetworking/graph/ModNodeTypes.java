...
public class ModNodeTypes {
    ...
    public static final NodeGroup ITEM_GROUP = new NodeGroup(Text.translatable("group.advanced_networking.item"), ITEM_SOURCE, ITEM_TARGET, SPLIT_ITEMS, MERGE_ITEMS, EMPTY_ITEM_STREAM, LIMIT_ITEMS);
